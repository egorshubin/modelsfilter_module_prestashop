...
<form action="" method="get" id="main-models-filter-form" class="models-filter-form-js models-filter-form"
      data-category-id="{$category_id}" data-category-slug="{$mainCategorySlug}">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-12"><div class="inputs-flex-group">
